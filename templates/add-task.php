    ...
    <form class="form" action="add-task.php" method="post" enctype="multipart/form-data" autocomplete="off">
        <div class="form__row">
            ...
            <input class="form__input <?= isset($errors['name']) ? 'form__input--error' : ''; ?>" type="text"
                   name="name" id="name" value="<?= strip_tags(get_post_val('name')); ?>"
        ...
        <div class="form__row">
            ...
            <select
                ...
                <?php foreach ($projects as $project): ?>
                    <option
                        value="<?= $project['id']; ?>" <?= validate_project('project', [$project['id']]) ? 'selected' : ''; ?>>
        ...
        <div class="form__row">
            ...
            <input class="form__input form__input--date <?= isset($errors['date']) ? 'form__input--error' : ''; ?>"
                   type="text" name="date" id="date" value="<?= strip_tags(get_post_val('date')); ?>"
